...
export class HomePageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let todo1 = new Todo();
    todo1.Tittle = "complete the training report. complete the training report"
    ...
    todo2.Tittle = "complete the todo frontend"
    ...
    this.todoService.getToDoList().subscribe({
      next :(res) =>{
        console.log("ToDo List Res : ", res)
        //console.log("ToDo List : ", res.todos)
        this.todoList = res;
        
      },
      error: (err) =>{
        console.log("ToDo List : ", err)
      }
    });
  }
